...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><g:layoutTitle default="Document Archival"/></title>
        ...
        <asset:stylesheet src="components.min.css"/>
        <asset:stylesheet src="plugins.min.css"/>
        <asset:stylesheet src="custom.min.css"/>
        <asset:stylesheet src="darkblue.min.css"/>
        <asset:stylesheet src="layout.min.css"/>
        <asset:stylesheet src="simple-line-icons.min.css"/>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                    	...
                    	<asset:image src="ICT_logo.png" alt="logo" style="height: 59px;padding-top: 7px;"/>
                    </a>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <asset:image src="avatar3_small.jpg" class="img-circle"/>
                                <span class="username username-hide-on-mobile"> 
                                	<b>Welcome <sec:loggedInUserInfo field="username"/>!!!</b> 
                                </span>
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                ...
                                <li>
                                    <a href="page_user_login_1.html">
                                        <g:link controller="logout"> Log Out </g:link></a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <asset:image src="avatar3_small.jpg"/>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; ICT Solution Nepal Pvt. Ltd.
...
<![endif]-->
        ...
        <asset:javascript src="js.cookie.min.js"/>
        <asset:javascript src="jquery.min.js"/>
        <asset:javascript src="bootstrap.min.js"/>
        <asset:javascript src="quick-sidebar.min.js"/>
        <asset:javascript src="demo.min.js"/>
        <asset:javascript src="layout.min.js"/>
